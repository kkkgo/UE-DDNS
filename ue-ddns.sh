...
getURLIP() {
    ...
    TESTURLS="$CHECKURL http://ipsu.03k.org http://test.ipw.cn https://www.cloudflare.com/cdn-cgi/trace http://ip.gs http://ident.me/ http://4.ipw.cn/ http://6.ipw.cn/ http://checkip.synology.com/ http://checkipv6.synology.com/ https://v4.ident.me/ https://v6.ident.me/"
